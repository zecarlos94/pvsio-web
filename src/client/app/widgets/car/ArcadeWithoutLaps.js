 ...
 *     "use strict";
 *
 *     // Require the ArcadeWithoutLaps module
 *     require("widgets/car/ArcadeWithoutLaps");
 *
 *     function main() {
 *          // After ArcadeWithoutLaps module was loaded, initialize it
 ...
 * 
 *          // Render the ArcadeWithoutLaps widget, updating Widget status with PVS status (vehicle position, posx and speed)
 ...
 *          // OR
 * 
 *          // Hides the ArcadeWithoutLaps widget
 *          arcade.hide();
 * 
 *          // OR
 * 
 *          // Reveals the ArcadeWithoutLaps widget
 *          arcade.reveal();
 *     }
 * });
 * 
 * @example <caption>Usage of <strong>Protected API</strong> within ArcadeWithoutLaps Widget. That is, API which is only used internally by the ArcadeWithoutLaps Widget to create the desired simulation</caption>
...
define(function (require, exports, module) {
    ...
    /* 
    * Start of ArcadeWithoutLaps Global Variables 
    */
    ...
    /* 
    * End of ArcadeWithoutLaps Global Variables 
    */

    /* 
    * Start of ArcadeWithoutLaps Colors 
    */
    let grass="";
    let border="";
    let outborder="";
    ...
    /* 
    * End of ArcadeWithoutLaps Colors 
    */
    
    /**
     * @function constructor
     * @public 
     * @description Constructor for the ArcadeWithoutLaps widget.
     ...
     * @returns {ArcadeWithoutLaps} The created instance of the widget ArcadeWithoutLaps.
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
    ...
    ArcadeWithoutLaps.prototype = Object.create(Widget.prototype);
    ArcadeWithoutLaps.prototype.constructor = ArcadeWithoutLaps;
    ArcadeWithoutLaps.prototype.parentClass = Widget.prototype;

     /**
     * @function startSimulation
     * @public 
     * @description StartSimulation method of the ArcadeWithoutLaps widget. This method loads the desired JSON Files and starts the corresponding simulation.
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
    ArcadeWithoutLaps.prototype.startSimulation = function () {
        setTimeout(function(){ 
            ...
            ArcadeWithoutLaps.prototype.onPageLoad(spritesFiles);
            loadingTrackNrIterations = setInterval(function(){ ArcadeWithoutLaps.prototype.getNrIterations(); }, 500);
        }, 50);
        return this;
    };
     ...
     * @function hide
     * @public 
     * @description Hide method of the ArcadeWithoutLaps widget. This method changes the current main div visibility to 'hidden'.
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
    ArcadeWithoutLaps.prototype.hide = function () {
     ...
     * @function reveal
     * @public 
     * @description Reveal method of the ArcadeWithoutLaps widget. This method changes the current main div visibility to 'visible'.
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
    ArcadeWithoutLaps.prototype.reveal = function () {
     ...
     * @protected 
     * @description GetNrIterations method of the ArcadeWithoutLaps widget. This method computes the number of iterations required to draw the track defined in the JSON configuration file. 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.getNrIterations = function () {
        try {
     ...
     * @function onPageLoad
     * @protected 
     * @description onPageLoad method of the ArcadeWithoutLaps widget. This method starts the arcade simulation and loads the required spritesheets, with all sprites defined in track object.
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.onPageLoad = function (spritesFiles) {
        ArcadeWithoutLaps.prototype.detectBrowserType();
        if(currentBrowser.chrome){ // can be ensured that all CSS will work as it is supposed!!!
            ArcadeWithoutLaps.prototype.init();
            ...
            spritesheetsImages[0].onload = function(){
                splashInterval = setInterval(ArcadeWithoutLaps.prototype.renderSplashFrame, 30);
            };
     ...
     * @protected 
     * @description RenderSplashFrame method of the ArcadeWithoutLaps widget. This method draws the simulator home page, where the commands to control the simulator are displayed. 
     ...
     * @instance
     */
     ArcadeWithoutLaps.prototype.renderSplashFrame = function () {  
        canvas.height = 240;
        canvas.width = 320;     
        ...
        if(readParams){
            ...
            if(readConfiguration && readSprite){
                ...
                ArcadeWithoutLaps.prototype.drawText("Instructions:",{x: 120, y: 90}, 1);
                ArcadeWithoutLaps.prototype.drawText("Click on space bar to start",{x: 60, y: 110}, 1);
                ArcadeWithoutLaps.prototype.drawText("Click on key s to pause",{x: 60, y: 120}, 1);
                ArcadeWithoutLaps.prototype.drawText("Click on key q to end",{x: 60, y: 130}, 1);
                ArcadeWithoutLaps.prototype.drawText("Use left and rigth arrows",{x: 80, y: 145}, 1);
                ArcadeWithoutLaps.prototype.drawText("to control the vehicle",{x: 90, y: 155}, 1);
                ArcadeWithoutLaps.prototype.drawText("You can start now",{x: 110, y: 175}, 1);
                ArcadeWithoutLaps.prototype.drawText("Credits:",{x: 145, y: 195}, 1);
                ArcadeWithoutLaps.prototype.drawText("Jose Carlos and PVSio-web",{x: 70, y: 210}, 1);
                ArcadeWithoutLaps.prototype.drawText("Interactive Prototype Builder",{x: 60, y: 220}, 1);                

                if(WIDGETSTATE!==null && WIDGETSTATE.action==="resume"){
                    clearInterval(splashInterval);
                    simulatorInterval = setInterval(ArcadeWithoutLaps.prototype.renderSimulatorFrame, 30);
                    soundWidget.reveal();
                    soundWidget.unmute();
                ...
                ArcadeWithoutLaps.prototype.drawText("Loading Configurations...",{x: 100, y: 95}, 1); 
            }
        }else{
            ArcadeWithoutLaps.prototype.drawText("Loading Parameters...",{x: 100, y: 68}, 1);  
        }
     ...
     * @protected 
     * @description RenderSplashPauseFrame method of the ArcadeWithoutLaps widget. This method draws the simulator pause page, where the commands to control the simulator and to resume the simulation(renderSimulatorFrame) are displayed. 
     * It is also resumed the lap timer, using jchronometer lib, as soon as the user uses the command to resume the simulation.
     * @memberof module:ArcadeWithoutLaps
     * @returns {ArcadeWithoutLaps} The created instance of the widget ArcadeWithoutLaps.
     * @instance
     */
    ArcadeWithoutLaps.prototype.renderSplashPauseFrame = function () { 
        canvas.height = 240;
        canvas.width = 320; 
        ...
        ArcadeWithoutLaps.prototype.drawText("Click on space bar to resume",{x: 60, y: 100}, 1);
        ArcadeWithoutLaps.prototype.drawText("Use left and rigth arrows",{x: 70, y: 135}, 1);
        ArcadeWithoutLaps.prototype.drawText("to control the car",{x: 100, y: 155}, 1);
        ArcadeWithoutLaps.prototype.drawText("Credits:",{x: 145, y: 195}, 1);
        ArcadeWithoutLaps.prototype.drawText("Jose Carlos and PVSio-web",{x: 70, y: 210}, 1);
        ArcadeWithoutLaps.prototype.drawText("Interactive Prototype Builder",{x: 60, y: 220}, 1);
     ...
     * @protected 
     * @description RenderSplashEndFrame method of the ArcadeWithoutLaps widget. This method draws the simulator end page, where the commands to control the simulator and to start another simulation(renderSimulatorFrame) are displayed. 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.renderSplashEndFrame = function () { 
        canvas.height = 240;
        canvas.width = 320; 
        context.fillStyle = "rgb(100,200,187)";//"rgb(0,0,0)";
        context.fillRect(0, 0, canvas.width, canvas.height);
        ...
        ArcadeWithoutLaps.prototype.drawText("Thank you for playing!",{x: 90, y: 100}, 1);
        ArcadeWithoutLaps.prototype.drawText("Click on space bar to start again",{x: 40, y: 125}, 1);
        ArcadeWithoutLaps.prototype.drawText("Credits:",{x: 145, y: 195}, 1);
        ArcadeWithoutLaps.prototype.drawText("Jose Carlos and PVSio-web",{x: 70, y: 210}, 1);
        ArcadeWithoutLaps.prototype.drawText("Interactive Prototype Builder",{x: 60, y: 220}, 1);
     ...
     * @function drawText
     * @protected 
     * @description DrawText method of the ArcadeWithoutLaps widget. This method draws text using sprite letters to simulate the arcade look. 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawText = function (string, pos, imageIndex) {
     ...
     * @protected 
     * @description DrawLanePos method of the ArcadeWithoutLaps widget. This method draws one lane in the desired position, received as argument.
     * @param pos1 {Float} 
     * @param scale1 {Float} 
     * @param offset1 {Float} 
     * @param pos2 {Float} 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawLanePos = function (pos1, scale1, offset1, pos2, scale2, offset2, color, indexPos, laneWidth) {
        ArcadeWithoutLaps.prototype.drawSegmentPortion(pos1, scale1, offset1, pos2, scale2, offset2,  indexPos-laneWidth, indexPos, color);
        return this;
    };
     ...
     * @function drawLanes
     * @protected 
     * @description DrawLanes method of the ArcadeWithoutLaps widget. This method draws lanes according to numLanes, received as argument.
     * @param pos1 {Float} 
     * @param scale1 {Float} 
     * @param offset1 {Float} 
     * @param pos2 {Float} 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawLanes = function (pos1, scale1, offset1, pos2, scale2, offset2, color, numLanes, laneWidth) {
        let alpha = 1.10/numLanes;
        if(numLanes>3){
            for(let i=0;i<numLanes;i++){
                ArcadeWithoutLaps.prototype.drawSegmentPortion(pos1, scale1, offset1, pos2, scale2, offset2, -0.55+(i*alpha), -0.55+(i*alpha)+laneWidth, color);
                ArcadeWithoutLaps.prototype.drawSegmentPortion(pos1, scale1, offset1, pos2, scale2, offset2,  0.55-(i*alpha)-laneWidth, 0.55-(i*alpha), color);
            }
        }else{
            ArcadeWithoutLaps.prototype.drawSegmentPortion(pos1, scale1, offset1, pos2, scale2, offset2, -0.55+alpha, -0.55+alpha+laneWidth, color);
            ArcadeWithoutLaps.prototype.drawSegmentPortion(pos1, scale1, offset1, pos2, scale2, offset2,  0.55-alpha-laneWidth, 0.55-alpha, color);
        }
        return this;
    };
     ...
     * @protected 
     * @description DrawGuidingLine method of the ArcadeWithoutLaps widget. This method draws a guiding line within the track.
     * @param pos1 {Float} 
     * @param scale1 {Float} 
     * @param offset1 {Float} 
     * @param pos2 {Float} 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawGuidingLine = function (pos1, scale1, offset1, pos2, scale2, offset2, delta1, delta2, color) {
     ...
     * @protected 
     * @description DrawSimpleArrowFront method of the ArcadeWithoutLaps widget. This method draws a guiding arrow on right top corner of the canvas.
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawSimpleArrowFront = function (x,y,color){
        context.fillStyle = color;
     ...
     * @protected 
     * @description DrawSimpleArrowDown method of the ArcadeWithoutLaps widget. This method draws a guiding arrow on right top corner of the canvas.
     * @param x {Int} Coordinate X of starting point, i.e. where simple arrow will be drawed.
     * @param y {Int} Coordinate Y of starting point, i.e. where simple arrow will be drawed.
     * @param color {String} CSS color to render the simple arrow, usually hexadecimal value.
     * @memberof module:ArcadeWithoutLaps
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawSimpleArrowDown = function (x,y,color){
        context.fillStyle = color;
        context.strokeStyle = color;
        context.lineWidth = 6;
        context.beginPath();
     ...
     * @protected 
     * @description DrawSimpleArrowLeft method of the ArcadeWithoutLaps widget. This method draws a guiding arrow on right top corner of the canvas.
     * @param x {Int} Coordinate X of starting point, i.e. where simple arrow will be drawed.
     * @param y {Int} Coordinate Y of starting point, i.e. where simple arrow will be drawed.
     * @param color {String} CSS color to render the simple arrow, usually hexadecimal value.
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawSimpleArrowLeft = function (x,y,color,direction){
        if(direction.inverse){
            ...
            ArcadeWithoutLaps.prototype.drawSimpleArrowRight(x,y,color,{inverse:true});
        }
        return this;
    };
     ...
     * @protected 
     * @description DrawSimpleArrowRight method of the ArcadeWithoutLaps widget. This method draws a guiding arrow on right top corner of the canvas.
     * @param x {Int} Coordinate X of starting point, i.e. where simple arrow will be drawed.
     * @param y {Int} Coordinate Y of starting point, i.e. where simple arrow will be drawed.
     * @param color {String} CSS color to render the simple arrow, usually hexadecimal value.
     * @param direction {Object} Object with inverse property, which indicates whether the guide 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawSimpleArrowRight = function (x,y,color,direction){
        if(direction.inverse){
            context.fillStyle = color;
            context.strokeStyle = color;
            context.lineWidth = 6;
            ...
            ArcadeWithoutLaps.prototype.drawSimpleArrowLeft(x,y,color,{inverse:true});
        }
        return this;
    };
     ...
     * @protected 
     * @description DrawArrowFront method of the ArcadeWithoutLaps widget. This method draws a guiding arrow in front of the vehicle.
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawArrowFront = function (x, y, width, height, color, withLine){
        // Arrow Head
        context.fillStyle = color;
        context.beginPath();
        context.moveTo(x, y);
     ...
     * @protected 
     * @description DrawArrowRight method of the ArcadeWithoutLaps widget. This method draws a guiding arrow, turned right, in front of the vehicle.
     * @param x {Int} Coordinate X of starting point, i.e. where arrow apex will be drawed.
     * @param y {Int} Coordinate Y of starting point, i.e. where arrow apex will be drawed.
     * @param width {Int} Arrow width(triangle).
     * @param height {Int} Arrow height(triangle).
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawArrowRight = function (x, y, width, height, color, withLine, direction) {
        if(direction.inverse){
            context.fillStyle = color;
            context.beginPath();
            ...
            ArcadeWithoutLaps.prototype.drawArrowLeft(x, y, width, height, color, withLine, {inverse:true});
        }
        return this;
    };
     ...
     * @protected 
     * @description DrawArrowLeft method of the ArcadeWithoutLaps widget. This method draws a guiding arrow, turned left, in front of the vehicle.
     * @param x {Int} Coordinate X of starting point, i.e. where arrow apex will be drawed.
     * @param y {Int} Coordinate Y of starting point, i.e. where arrow apex will be drawed.
     * @param width {Int} Arrow width(triangle).
     * @param height {Int} Arrow height(triangle).
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawArrowLeft = function (x, y, width, height, color, withLine, direction){
        if(direction.inverse){
            context.save();
            context.fillStyle = color;
            context.beginPath();
            ...
            ArcadeWithoutLaps.prototype.drawArrowRight(x, y, width, height, color, withLine, {inverse:true});
        }
        return this;
    };
     ...
     * @function drawSprite
     * @protected 
     * @description DrawSprite method of the ArcadeWithoutLaps widget. This method draws an image of spritesheetsImages array. Usually it uses index 0, since this method is used to 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawSprite = function (sprite, image, x, y, scale) {
        if(sprite!==null){
     ...
     * @protected 
     * @description DrawSegmentPortion method of the ArcadeWithoutLaps widget. This method draws a segment portion.
     * @param pos1 {Float} 
     * @param scale1 {Float} 
     * @param offset1 {Float} 
     * @param pos2 {Float} 
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawSegmentPortion = function (pos1, scale1, offset1, pos2, scale2, offset2, delta1, delta2, color) {
        let demiWidth = render.width / 2;
     ...
     * @protected 
     * @description DrawBackground method of the ArcadeWithoutLaps widget. This method draws the background image, in position 'position'.
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.drawBackground = function (position) {
        let first = position / 2 % (background.w);
        //(image, x, y, scale) args
        ArcadeWithoutLaps.prototype.drawSprite(null, background, first-background.w +1, 0, 1);
        ArcadeWithoutLaps.prototype.drawSprite(null, background, first+background.w-1, 0, 1);
        ArcadeWithoutLaps.prototype.drawSprite(null, background, first, 0, 1);
        return this;
    };
     ...
     * @protected 
     * @description SetColorsEndCanvas method of the ArcadeWithoutLaps widget. This method set the final colors of the track segment and lane.
     ...
     * @instance
     */ 
    ArcadeWithoutLaps.prototype.setColorsEndCanvas = function (track_segment, lane) {
     ...
     * @protected 
     * @description SetColorsCanvas method of the ArcadeWithoutLaps widget. This method set the initial colors of canvas, which will prevail until the end of the track is reached.
     ...
     * @instance
     */ 
    ArcadeWithoutLaps.prototype.setColorsCanvas = function (alternate, grass1, border1, border2, outborder1, outborder_end1, track_segment1, lane1, lane2, laneArrow1) {
        grass          = grass1;
     ...
     * @protected 
     * @description DrawSegment method of the ArcadeWithoutLaps widget. This method draws a segment of the simulator(which corresponds to an entire strip of the canvas). 
     ...
     * @instance
     */ 
    ArcadeWithoutLaps.prototype.drawSegment = function (position1, scale1, offset1, position2, scale2, offset2, finishStart) {
        if(finishStart){
            ArcadeWithoutLaps.prototype.setColorsEndCanvas(track_segment_end, lane_end);
            ...
            // draw the track
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, trackP1, trackP2, "#fff");

            //draw the track border
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, borderP1, borderP2, border);
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -borderP2, -borderP1, border);

            //draw the track outborder dark green
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, inBorderP1, inBorderP2, outborder_end);
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, landscapeOutBorderP1, landscapeOutBorderP2, outborder);
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, outBorderP2, outBorderP1, outborder_end);

            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -inBorderP2, -inBorderP1, outborder_end);
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -landscapeOutBorderP2, -landscapeOutBorderP1, outborder);
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -outBorderP1, -outBorderP2, outborder_end);

            // // draw the lane line
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, laneP1, laneP2, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, laneP3, laneP4, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, laneP5, laneP6, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, laneP7, laneP8, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -laneP8, 0, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -laneP6, -laneP7, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -laneP4, -laneP5, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -laneP2, -laneP3, "#000");
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, -laneP1+diffLanesFinishLine, -laneP1, "#000");

            // draw arrow or guiding line
            // ArcadeWithoutLaps.prototype.drawGuidingLine(position1, scale1, offset1, position2, scale2, offset2, -0.02, 0.02, laneArrow);
            if(carCurrentDirection==="front"){
                // ArcadeWithoutLaps.prototype.drawArrowFront(160, 150, 12, 18, laneArrow, 1);
                ArcadeWithoutLaps.prototype.drawSimpleArrowFront(canvas.width-50,30,laneArrow);
            }else if(carCurrentDirection==="right"){
                // ArcadeWithoutLaps.prototype.drawArrowLeft(160, 150, 20, 20, laneArrow, 1, {inverse:false});
                ArcadeWithoutLaps.prototype.drawSimpleArrowLeft(canvas.width-50,30,laneArrow,{inverse:false});
            }else if(carCurrentDirection==="left"){
                // ArcadeWithoutLaps.prototype.drawArrowRight(160, 150, 20, 20, laneArrow, 1, {inverse:false});
                ArcadeWithoutLaps.prototype.drawSimpleArrowRight(canvas.width-50,30,laneArrow,{inverse:false});
            }
        }
        else{
            //draw grass:
            ...
            // draw the track
            ArcadeWithoutLaps.prototype.drawSegmentPortion(position1, scale1, offset1, position2, scale2, offset2, trackP1, trackP2, track_segment);
            ...
            // draw the lane line
            ArcadeWithoutLaps.prototype.drawLanes(position1, scale1, offset1, position2, scale2, offset2, lane, numLanes, laneWidth);
            // ArcadeWithoutLaps.prototype.drawLanePos(position1, scale1, offset1, position2, scale2, offset2, lane, 0, laneWidth);
     ...
     * @protected 
     * @description UpdateControllableCar method of the ArcadeWithoutLaps widget. This method updates the controllable car position and speed.
     * @memberof module:ArcadeWithoutLaps
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.updateControllableCar = function () {
     ...
     * @protected 
     * @description SetControllableCarPosition method of the ArcadeWithoutLaps widget. This method sets the controllable car position, posx, speed and vehicle sprite based on current direction.
     ...
     * @instance
     */
    ArcadeWithoutLaps.prototype.setControllableCarPosition = function (vehicleCurrentDirection, newSpeed, newPosition, newPositionX, vehicleXPosition, vehicleYPosition) {
     ...
     * @protected 
     * @description calculateNewControllableCarPosition method of the ArcadeWithoutLaps widget. This method calculates the new controllable car position, based on
     ...
     * @protected 
     * @description RenderSimulatorFrame method of the ArcadeWithoutLaps widget. This method renders each frame during the simulation.
     * @memberof module:ArcadeWithoutLaps
     * @returns {ArcadeWithoutLaps} The created instance of the widget ArcadeWithoutLaps.
     * @instance
     */
    ArcadeWithoutLaps.prototype.renderSimulatorFrame = function () {
        ...
        if(WIDGETSTATE!==null && WIDGETSTATE.action==="quit"){ // Key 'q' ends current simulator
            ...
            soundWidget.hide();
            clearInterval(simulatorInterval);
            splashInterval = setInterval(ArcadeWithoutLaps.prototype.renderSplashEndFrame, 30);
            soundWidget.pauseAll();
        }
        ...
        if(WIDGETSTATE!==null && WIDGETSTATE.action==="pause"){ // Key 's' pauses current simulator
            ...
            soundWidget.hide();
            clearInterval(simulatorInterval);
            splashInterval = setInterval(ArcadeWithoutLaps.prototype.renderSplashPauseFrame, 30);
            soundWidget.pauseAll();
        }
        ...
        if(loadPVSSpeedPositions){
            // Using PVS results
            ArcadeWithoutLaps.prototype.calculateNewControllableCarPosition();
            carSprite = ArcadeWithoutLaps.prototype.setControllableCarPosition(vehicleCurrentDirectionAux, newSpeedAux, newPositionAux, newPositionXAux, vehicleXPositionAux, vehicleYPositionAux);
        }else{
            // Using only JS to update rendered vehicle
            carSprite = ArcadeWithoutLaps.prototype.updateControllableCar();
        }

        ArcadeWithoutLaps.prototype.drawBackground(-controllable_car.posx);
        ...
        while (iter--) {
            ...
            if(currentHeight > endProjectedHeight){
                ArcadeWithoutLaps.prototype.setColorsCanvas(counter < numberOfSegmentPerColor, grass1, border1, border2, outborder1, outborder_end1, track_segment1, lane1, lane2, laneArrow1);
                ArcadeWithoutLaps.prototype.drawSegment(
                    render.height / 2 + currentHeight,
                    currentScaling, currentSegment.curve - baseOffset - lastDelta * currentScaling,
                    render.height / 2 + endProjectedHeight,
                    endScaling,
        ...
        while((sptB = spriteBuffer.pop())!==undefined) {
            ArcadeWithoutLaps.prototype.drawSprite(sptB, null, null, null, null);
        }
            
        // Draw the car 
        ArcadeWithoutLaps.prototype.drawSprite(null, carSprite.car, carSprite.x, carSprite.y, 1);

        if(absoluteIndex >= numIterations-render.depthOfField-1){
            clearInterval(simulatorInterval);
            ArcadeWithoutLaps.prototype.drawText("Simulation Ended!", {x: 90, y: 40}, 1);
            ArcadeWithoutLaps.prototype.drawText("Wait 5 Seconds To Reload", {x: 60, y: 60}, 1);
            ArcadeWithoutLaps.prototype.drawText("The Simulator", {x: 100, y: 70}, 1);
            soundWidget.pauseAll();
        ...
        if(currentPercentage>100){
            ArcadeWithoutLaps.prototype.drawText("Current Lap 100%",{x: 100, y: 1},1); 
        }else{
            ArcadeWithoutLaps.prototype.drawText("Current Lap "+currentPercentage+"%",{x: 100, y: 1},1); 
        }
        ...
        if(WIDGETSTATE!==null){
            if(WIDGETSTATE.speed.val!=="0"){
                ...
                ArcadeWithoutLaps.prototype.drawText(""+lastSpeedPVS+" kmh", {x: 260, y: 1}, 1);
            }else{
                ArcadeWithoutLaps.prototype.drawText(""+0+" kmh", {x: 260, y: 1}, 1);
            }
            if(WIDGETSTATE.rpm!=="0"){
                ...
                ArcadeWithoutLaps.prototype.drawText(""+lastRPMPVS+" rpm", {x: 10, y: 1}, 1);
            }else{
                ArcadeWithoutLaps.prototype.drawText(""+0+" rpm", {x: 10, y: 1}, 1);
            }
        }
        ...
        ArcadeWithoutLaps.prototype.drawText(currentTimeString, {x: 80, y: 15}, 1);
     ...
     * @protected 
     * @description DetectBrowserType method of the ArcadeWithoutLaps widget. This method detects current open Browser.
     * @memberof module:ArcadeWithoutLaps
     * @returns {ArcadeWithoutLaps} The created instance of the widget ArcadeWithoutLaps.
     * @instance
     */
    ArcadeWithoutLaps.prototype.detectBrowserType = function () {
     ...
     * @function init
     * @protected 
     * @description Init method of the ArcadeWithoutLaps widget. This method inits the canvas and adds the events onkeydown and onkeyup to capture the desired actions, i.e. accelerate, brake, etc.
     * @memberof module:ArcadeWithoutLaps
     * @returns {ArcadeWithoutLaps} The created instance of the widget ArcadeWithoutLaps.
     * @instance
     */
    ArcadeWithoutLaps.prototype.init = function () {
     ...
     * @function render
     * @public 
     * @description Render method of the ArcadeWithoutLaps widget. 
     * @param pvsState {Float} the new PVS state.
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
    ArcadeWithoutLaps.prototype.render = function (pvsState) {
        WIDGETSTATE = pvsState;
        return this.reveal();
    };

    module.exports = ArcadeWithoutLaps;
});
