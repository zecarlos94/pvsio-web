...
define(function (require, exports, module) {
     ...
     * @public
     * @description StartSimulation method of the ArcadeWithoutLaps widget. This method sets timeout to load all configuration files provided as opt fields (dynamic require).
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
     ...
     * @public
     * @description StartSimulationAux method of the ArcadeWithoutLaps widget. This method loads the desired JSON Files and starts the corresponding simulation.
     * @memberof module:ArcadeWithoutLaps
     * @instance
     */
    ArcadeWithoutLaps.prototype.startSimulationAux = function () { 
     ...
     * @protected
     * @description DrawBackground method of the ArcadeWithoutLaps widget. This method draws the main_sprites.background image, in position 'position'.
    ...
    ArcadeWithoutLaps.prototype.drawSegment = function (position1, scale1, offset1, position2, scale2, offset2, finishStart) {
        if(finishStart){
            ...
            // ArcadeWithoutLaps.prototype.drawGuidingLine(position1, scale1, offset1, position2, scale2, offset2, -0.02, 0.02, arcadeColors.laneArrow);
