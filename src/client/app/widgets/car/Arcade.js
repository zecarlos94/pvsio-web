 ...
 * 
 *          // Draws the guiding arrow with color rgb(100,200,187) received as argument
 *          Arcade.prototype.drawArrowHead("rgb(100,200,187)");
 * 
 *     }
 * });
 */
...
define(function (require, exports, module) {
    ...
    */
     ...
     * @description DrawArrowHead method of the Arcade widget. This method draws a guiding arrow in front of the vehicle.
     ...
     * @instance
     */
    Arcade.prototype.drawArrowHead = function (x, y, width, height, color){
        context.fillStyle = color;
        context.beginPath();
        context.moveTo(x, y);
     ...
     * @instance
     */
    Arcade.prototype.drawArrowRight = function (x, y, width, height, color) {
        context.fillStyle = color;
        context.beginPath();
     ...
     * @instance
     */
    Arcade.prototype.drawArrowLeft = function (x, y, width, height, color){
        context.save();
        context.fillStyle = color;
        context.beginPath();
        context.moveTo(x, y);
    ...
    Arcade.prototype.drawSegment = function (position1, scale1, offset1, position2, scale2, offset2, finishStart) {
        if(finishStart){
            ...
            Arcade.prototype.drawArrowHead(160, 150, 15, 15, laneArrow);
            // Arcade.prototype.drawArrowLeft(30, 20, 20, 20, laneArrow);
            // Arcade.prototype.drawArrowRight(160, 150, 20, 20, laneArrow);
        }
        else{
            //draw grass:
            context.fillStyle = grass;
