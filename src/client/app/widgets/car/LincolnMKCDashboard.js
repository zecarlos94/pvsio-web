...
define(function (require, exports, module) {
     ...
     * @param [opt.fullDashboard] {Bool} allows to display full dashboard or just the cropped section to analyze (default is false).
    ...
    function LincolnMKCDashboard(id, coords, opt) {
        ...
        this.fullDashboard = (opt.fullDashboard) ? (opt.fullDashboard) : false;


        let _this = this;
        let lincolnMKCDashboard_file;

        if(this.fullDashboard){
        	lincolnMKCDashboard_file = "text!widgets/car/lincoln_mkc_dashboard_case_study/2015_lincoln_mkc_"+this.design+"_recall.svg";
        }else{
        	lincolnMKCDashboard_file = "text!widgets/car/lincoln_mkc_dashboard_case_study/MKC_"+this.design+"_recall.svg";
        }

        require([lincolnMKCDashboard_file], function(lincolnMKCDashboardFile) {
        	if(_this.fullDashboard){
				_this.div.append("div").attr("id", "lincolnMKCDashboard_"+id+"_SW").attr("style", "zoom: 280%").html(lincolnMKCDashboardFile);
        	} else{
		...
		if(this.fullDashboard){
			if(this.design==="before"){
	            this.startAndStop= new Button(this.buttonsPVS[0], {
	                top: 350, left: 40, width: 36, height: 56
	            }, {
	                keyCode: 72, // Key 'h' 
	            ...
	            this.activateSportMode= new Button(this.buttonsPVS[1], {
	                top: 305, left: 40, width: 36, height: 36
	            }, {
	                keyCode: 74, // Key 'j' 
	                parent: "lincolnMKCDashboard_"+this.LINCOLNMKCDASHBOARDID,
	                callback: opt.callback,
	            ...
	            this.startAndStop= new Button(this.buttonsPVS[0], {
	                top: 120, left: 50, width: 36, height: 56
	            }, {
	                keyCode: 72, // Key 'h' 
	                parent: "lincolnMKCDashboard_"+this.LINCOLNMKCDASHBOARDID,
	                callback: opt.callback,
	            ...
	            this.activateSportMode= new Button(this.buttonsPVS[1], {
	                top: 440, left: 50, width: 36, height: 56
	            }, {
	                keyCode: 74, // Key 'j' 
	                parent: "lincolnMKCDashboard_"+this.LINCOLNMKCDASHBOARDID,
	                callback: opt.callback,
