 ...
 *
 * @example <caption>Usage of DrawGamepad2 within a PVSio-web demo.</caption>
 * define(function (require, exports, module) {
 *     "use strict";
 *
 *     // Require the DrawGamepad2 module
 *     require("widgets/car/DrawGamepad2");
 *
 *     function main() {
 *          // After DrawGamepad2 module was loaded, initialize it
 *          let wheel = new DrawGamepad2(
 *               'example', // id of the gauge element that will be created
 *               { top: 100, left: 100, width: 300, height: 300 }, // coordinates object
 *               { style: 'ps4' } // options
 *           );
 *
 *          // Render the DrawGamepad2 widget
 *          wheel.render();
 *     }
 * });
 */
...
define(function (require, exports, module) {
     ...
     * @description Constructor for the DrawGamepad2 widget.
     ...
     * @returns {DrawGamepad2} The created instance of the widget DrawGamepad2.
     * @memberof module:DrawGamepad2
     * @instance
     */
    function DrawGamepad2(id, coords, opt) {
        opt = opt || {};
    ...
    DrawGamepad2.prototype = Object.create(Widget.prototype);
    DrawGamepad2.prototype.constructor = DrawGamepad2;
    DrawGamepad2.prototype.parentClass = Widget.prototype;

    /**
     * @function hide
     * @description hide method of the DrawGamepad2 widget. This method changes parent div display to none.
     * @memberof module:DrawGamepad2
     * @instance
     */
    DrawGamepad2.prototype.hide = function () {
        return this.div.style("display","none");
    };

    /**
     * @function reveal
     * @description reveal method of the DrawGamepad2 widget. This method changes parent div display to block.
     * @memberof module:DrawGamepad2
     * @instance
     */
    DrawGamepad2.prototype.reveal = function () {
        return this.div.style("display","block");
    };

     /**
     * @function callPressReleasePVS
     * @description CallPressReleasePVS method of the DrawGamepad2 widget. This method calls a PVS function in main.pvs file, based on the required buttonName.
     * @memberof module:DrawGamepad2
     * @instance
     */
    DrawGamepad2.prototype.callPressReleasePVS = function (buttonName) {
     ...
     * @description CallClickPVS method of the DrawGamepad2 widget. This method calls a PVS function in main.pvs file, based on the required buttonName.
     * @memberof module:DrawGamepad2
     * @instance
     */
    DrawGamepad2.prototype.callClickPVS = function (buttonName) {
        ButtonActionsQueue.queueGUIAction("click_"+buttonName, this.callback);
     }
 
    /**
     * @function render
     * @description Render method of the DrawGamepad2 widget.
     * @memberof module:DrawGamepad2
     * @instance
     */
    DrawGamepad2.prototype.render = function () {
        if(this.style==="ps4"){
        ...
        // this.callPressReleasePVS("a");
        // this.callClickPVS("leftStick");

        return this.reveal();
    };

    module.exports = DrawGamepad2;
});
